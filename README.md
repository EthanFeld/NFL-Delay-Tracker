...
When a venue is outside NWS coverage or a game is more than seven days away, Open-Meteo's global ECMWF IFS ensemble may provide weather-code member counts through the schedule's 14-day window. Its roughly 25 km grid and 3-hour native step provide conditions only; they cannot estimate thunderstorms, lightning delay odds, or storm motion. Those games show no numeric delay risk.
